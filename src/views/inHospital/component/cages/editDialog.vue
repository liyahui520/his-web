<template>
	<div class="inHospital-Cages-edit">
			...
			<el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="100px" :rules="rules">
				<el-row :gutter="12">
					...
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="笼位名称" prop="name">
							<el-input v-model="ruleForm.name" placeholder="请输入笼位名称" clearable="" />
						</el-form-item>
					</el-col>

					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="笼位类型" prop="inHospitalType">
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="笼位位置" prop="location">
							<el-input v-model="ruleForm.location" placeholder="请输入笼位位置" clearable="" />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="笼位尺寸" prop="size">
							<el-input v-model="ruleForm.size" placeholder="长*宽*高" clearable="" />
						</el-form-item>
					</el-col>
					...
					<el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
						<el-form-item label="是否可用" prop="location">
...
const rules = ref<FormRules>({
	name: [{ required: true, message: '请输入笼位名称！', trigger: 'blur' }],
	inHospitalType: [{ required: true, message: '请选择笼位类型！', trigger: 'blur' }],
	...
	ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
		if (isValid) {
			...
			if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
				await getAPI(InHospitalApi).apiInHospitalEditRoomsPost(values);
			} else {
				await getAPI(InHospitalApi).apiInHospitalAddRoomsPost(values);
			}
			closeDialog();
		}
	});
