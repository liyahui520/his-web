...
<script lang="ts" setup name="refundAccount">
    ...
    const valueChang = async () => {
        dynamicValidateForm.occurPrice = (Number.parseFloat(verifyNumberIntegerAndFloat(dynamicValidateForm.principalPrice)) + Number.parseFloat(verifyNumberIntegerAndFloat(dynamicValidateForm.givePrice))).toFixed(2)
    }
