<template>
    <div class="product-consumables-edit-container">
        <el-dialog v-model="isShowDialog" :title="props.title" draggable :close-on-click-modal="false">
            ...
            <el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="100px" :rules="rules">
                <el-divider content-position="left" style="padding: 0;margin: 15px">消耗品信息</el-divider>
                <el-row :gutter="35">
                    ...
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                        <el-form-item label="消耗品编码">
                            <el-input v-model="ruleForm.serialNumber" :disabled="editSerialNumber" placeholder="请输入消耗品编码"
                ...
                <el-row :gutter="35">
                    ...
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                        <el-form-item label="状态">
                            ...
                            <!--                            <el-checkbox label="停用" v-model="ruleForm.isDisable" />-->
    ...
    ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
        if (isValid) {
            ...
            if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
                await getAPI(ProductConsumablesApi).apiProductConsumablesEditPut(values);
            } else {
                await getAPI(ProductConsumablesApi).apiProductConsumablesAddPost(values);
            }
            closeDialog();
        }
    });
...
.product-consumables-edit-container {
    .el-tag {
        white-space: normal;
        height: auto;
        padding: 9px 9px;
