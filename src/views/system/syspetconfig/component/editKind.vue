<template>
	<div class="sys-pet-kind-container">
			...
			<el-form :model="state.ruleForm" ref="ruleFormRef" size="default" label-width="80px">
				<el-row :gutter="35">
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="种类名称" prop="name" :rules="[{ required: true, message: '种类名称不能为空', trigger: 'blur' }]">
							<el-input v-model="state.ruleForm.name" @change="pinyin" placeholder="种类名称" clearable />
						</el-form-item>
					</el-col>
					<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
						<el-form-item label="种类拼音" prop="englishName">
							<el-input v-model="state.ruleForm.englishName" placeholder="种类拼音" disabled />
						</el-form-item>
					</el-col>
...
<script lang="ts" setup name="sysEditPetKind">
...
const emits = defineEmits(['submitRefresh']);
...
const state = reactive({
	isShowDialog: false,
	ruleForm: {} as EditSysPetKindInput,
});
