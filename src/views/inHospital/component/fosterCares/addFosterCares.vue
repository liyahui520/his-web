	...
	<div class="in-hospitals-add-hospital">
		<el-dialog v-model="isShowDialog" :title="props.title" width="70%" draggable :close-on-click-modal="false">
			...
			<el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="100px" :rules="rules">
				<el-row :gutter="8">
					<el-col :span="8">
						<el-card shadow="never" style="height: 500px;border: 1px solid var(--el-border-color-lighter);">
							<el-row :gutter="35">
								...
								<el-col :xs="24" :sm="24" :md="24" :lg="24" :xl="24" class="mb20">
									<el-form-item label="描述">
										<el-input type="textarea" v-model="ruleForm.remark" placeholder="请输入描述" maxlength="200"></el-input>
									</el-form-item>
								</el-col>
							</el-row>
						</el-card>
					...
					<el-col :span="16">
						<el-card shadow="never" style="height: 500px;border: 1px solid var(--el-border-color-lighter);">
							...
							<el-table ref="tableDataRef" :data="tableData" v-loading="loading" style="height: 450px" tooltip-effect="light" row-key="id" border empty-text="暂无空余笼位">
 ...
 * @param data
 */
const headChange = (data: any) => {
	ruleForm.value.headName = doctorUserObject.value[data];
};
/**
 * 获取负责人列表
 */
 ...
 * @param row 选中的宠物数据
 */
const selectPet = (data: any) => {
	ruleForm.value.customerName = data.customerName;
	ruleForm.value.cellPhone = data.cellPhone;
	ruleForm.value.customerId = data.id;
	ruleForm.value.petName = data.petName;
	ruleForm.value.petId = data.petId;
	ruleForm.value.petKindText = data.petKindText;
	ruleForm.value.petVarietieText = data.petVarietieText;
};
