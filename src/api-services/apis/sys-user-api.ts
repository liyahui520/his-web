...
import { AdminResultListUserOutput } from '../models';
/**
...
export const SysUserApiAxiosParamCreator = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        apiSysUserGetUserGet: async (options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            const localVarPath = `/api/sysUser/get-user`;
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
         ...
         * @throws {RequiredError}
         */
        apiSysUserOwnChargesListUserIdGet: async (userId: number, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'userId' is not null or undefined
            if (userId === null || userId === undefined) {
                throw new RequiredError('userId', 'Required parameter userId was null or undefined when calling apiSysUserOwnChargesListUserIdGet.');
            }
            const localVarPath = `/api/sysUser/ownChargesList/{userId}`
                .replace(`{${"userId"}}`, encodeURIComponent(String(userId)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
        ...
        /**
         * 
         * @summary 根据用户职位获取用户集合
         * @param {string} posCode 职位编码
         * @param {*} [options] Override http request option.
         * @throws {RequiredError}
         */
        apiSysUserByPosPosCodeGet: async (posCode: string, options: AxiosRequestConfig = {}): Promise<RequestArgs> => {
            // verify required parameter 'posCode' is not null or undefined
            if (posCode === null || posCode === undefined) {
                throw new RequiredError('posCode','Required parameter posCode was null or undefined when calling apiLaboratoryUsersByPosPosCodeGet.');
            }
            const localVarPath = `/api/sysUser/usersByPos/{posCode}`
                .replace(`{${"posCode"}}`, encodeURIComponent(String(posCode)));
            // use dummy base URL string because the URL constructor only accepts absolute URLs.
            const localVarUrlObj = new URL(localVarPath, 'https://example.com');
            let baseOptions;
            if (configuration) {
...
export const SysUserApiFp = function (configuration?: Configuration) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysUserGetUserGet(options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListSysUser>>> {
            const localVarAxiosArgs = await SysUserApiAxiosParamCreator(configuration).apiSysUserGetUserGet(options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs: AxiosRequestConfig = {
                    ...localVarAxiosArgs.options,
                    url: basePath + localVarAxiosArgs.url
         ...
         * @throws {RequiredError}
         */
        async apiSysUserOwnChargesListUserIdGet(userId: number, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListInt64>>> {
            const localVarAxiosArgs = await SysUserApiAxiosParamCreator(configuration).apiSysUserOwnChargesListUserIdGet(userId, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs: AxiosRequestConfig = {
                    ...localVarAxiosArgs.options,
                    url: basePath + localVarAxiosArgs.url
         ...
         * @throws {RequiredError}
         */
        async apiSysUserByPosPosCodeGet(posCode: string, options?: AxiosRequestConfig): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<AdminResultListUserOutput>>> {
            const localVarAxiosArgs = await SysUserApiAxiosParamCreator(configuration).apiSysUserByPosPosCodeGet(posCode, options);
            return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
                const axiosRequestArgs :AxiosRequestConfig = {...localVarAxiosArgs.options, url: basePath + localVarAxiosArgs.url};
                return axios.request(axiosRequestArgs);
            };
...
export const SysUserApiFactory = function (configuration?: Configuration, basePath?: string, axios?: AxiosInstance) {
    return {
         ...
         * @throws {RequiredError}
         */
        async apiSysUserGetUserGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListSysUser>> {
            return SysUserApiFp(configuration).apiSysUserGetUserGet(options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary 删除用户
         ...
         * @throws {RequiredError}
         */
        async apiSysUserOwnChargesListUserIdGet(userId: number, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListInt64>> {
            return SysUserApiFp(configuration).apiSysUserOwnChargesListUserIdGet(userId, options).then((request) => request(axios, basePath));
        },
        /**
         *
         * @summary 获取用户拥有角色集合
         ...
         * @throws {RequiredError}
         */
        async apiSysUserByPosPosCodeGet(posCode: string, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListUserOutput>> {
            return SysUserApiFp(configuration).apiSysUserByPosPosCodeGet(posCode, options).then((request) => request(axios, basePath));
        },
    };
};
...
export class SysUserApi extends BaseAPI {
     ...
     * @memberof SysUserApi
     */
    public async apiSysUserGetUserGet(options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListSysUser>> {
        return SysUserApiFp(this.configuration).apiSysUserGetUserGet(options).then((request) => request(this.axios, this.basePath));
    }
     ...
     * @memberof SysUserApi
     */
    public async apiSysUserOwnChargesListUserIdGet(userId: number, options?: AxiosRequestConfig): Promise<AxiosResponse<AdminResultListInt64>> {
        return SysUserApiFp(this.configuration).apiSysUserOwnChargesListUserIdGet(userId, options).then((request) => request(this.axios, this.basePath));
    }
     ...
     */
    public async apiSysUserByPosPosCodeGet(posCode: string, options?: AxiosRequestConfig) : Promise<AxiosResponse<AdminResultListUserOutput>> {
        return SysUserApiFp(this.configuration).apiSysUserByPosPosCodeGet(posCode, options).then((request) => request(this.axios, this.basePath));
    }
}
