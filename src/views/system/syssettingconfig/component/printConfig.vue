			...
			<span>
				...
				<el-row :gutter="20" style="padding: 0px 40px 0px">
					<el-form :inline="true" class="demo-form-inline" ref="serNumberFromRef" :model="serNumberFrom" :rules="serNumberFromRules">
						...
						<el-form-item>
							<el-button type="info" v-if="!isPcuPetSerNumber" @click="editSerNumberConfig">{{ '修改' }}</el-button>
							<el-button type="info" v-if="isPcuPetSerNumber" @click="cancelSerNumberConfig">{{ '取消修改' }}</el-button>
				...
				<el-row :gutter="20" style="padding: 0px 40px 0px">
					...
					<div style="align-content: flex-end">
						<el-button
							...
							>{{ '修改' }}</el-button
						>
						<el-button type="info" v-if="isPcuLevel" @click="cancelPcuLevel">{{ '取消修改' }}</el-button>
