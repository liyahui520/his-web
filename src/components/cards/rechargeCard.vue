    ...
    <div class="rechargeCard-container">
        <el-dialog v-model="isShowDialog" width="50%" draggable :close-on-click-modal="false" destroy-on-close>
            ...
            <el-descriptions style="margin-top: 30px;" :column="3" :border="false" size="large">
                <el-descriptions-item width="12%" label="本金总金额"><el-text tag="b">{{ computedOriAmout
                        }}</el-text></el-descriptions-item>
                <el-descriptions-item width="12%" label="赠送金额"><el-text tag="b">{{ ruleForm.giveAmount
                        }}</el-text></el-descriptions-item>
...
const submitForm = async () => {
    ...
    await getAPI(MemberCardApi).apiMemberCardRanchargeMembercardPost(ruleForm.value).then((res) => {
