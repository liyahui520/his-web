<template>
    <div class="product-hospitals-container">
                ...
                <el-row :gutter="35">
                    ...
                    <el-col :xs="24" :sm="12" :md="12" :lg="12" :xl="12" class="mb20">
                        <el-form-item label="编码">
                            <el-input v-model="ruleForm.serialNumber" :disabled="editSerialNumber" placeholder="请输入编码"
                                clearable="" />
                        </el-form-item>
                    </el-col>
                </el-row>
    ...
    ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
        if (isValid) {
            ...
            if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
                await getAPI(ProductHospitalsApi).apiProductHospitalsEditPut(values);
            } else {
                await getAPI(ProductHospitalsApi).apiProductHospitalsAddPost(values);
            }
            closeDialog();
        }
    });
