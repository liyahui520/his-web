...
set apiServicesPath=%dir%..\src\api-services-bak\
...
java -jar %dir%swagger-codegen-cli.jar generate -i http://localhost:5050/swagger/All%%20Groups/swagger.json -l typescript-axios -o %apiServicesPath%
