<template>
  ...
  <el-card class="full-table" shadow="never" style="margin-top: 0;height: calc(100vh - 305px);padding: 0"
...
const tb = reactive<TableDemoState>({
  ...
  tableData: {
    ...
    search: [
      ...
      {
        label: '挂号医生', prop: 'doctorId', placeholder: '请选择挂号医生', required: false, type: 'select',
        options: [],
        optionkey: 'value',
        optionname: 'label'
      },{
