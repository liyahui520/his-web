...
const preView = () => {
	...
	let tempData: any = printData;
	if (state.mode == 1 || state.mode == 2) tempData = instorePrintData;
	else if (state.mode == 3) tempData = inspectionTestData;
	else if (state.mode == 6) tempData = cEMRecordPrescriptiondata;
