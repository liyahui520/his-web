		...
		<el-dialog v-model="isShowDialog" :title="props.title" width="80%" draggable :close-on-click-modal="false">
			...
			<el-form :model="ruleForm" ref="ruleFormRef" size="default" label-width="80px" :rules="rules">
				<el-row :gutter="8">
					...
					<el-col :span="16">
						<!-- <el-card shadow="always" style="height: 380px;padding-bottom: 40px;">
                            <template #header>
                                <el-row justify="space-between">
                                    ...
                                    <el-col :span="6">
                                        <el-button icon="ele-Plus" size="small"  type="primary" @click="openInspectionsDialog"> 新增
                                        </el-button>
                                        <el-button icon="ele-Delete" size="small" type="danger" @click="selectInspectionsClear">
                                            清空
                                        </el-button>
                                    </el-col>
                                </el-row>
                            </template>
                            <el-table :data="ruleForm.productMedicationInspectionDetails" style="width: 100%">
                                ...
                                <el-table-column label="犬" align="center">
                                    <el-table-column prop="dogMax" align="center" label="最大" />
                                    <el-table-column prop="dogMin" align="center" label="最小" />
                                </el-table-column>
                                <el-table-column label="猫" align="center">
                                    <el-table-column prop="catMax" align="center" label="最大" />
                                    <el-table-column prop="catMin" align="center" label="最小" />
                                </el-table-column>
                                <el-table-column label="其他" align="center">
                                    <el-table-column prop="otherMax" align="center" label="最大" />
                                    <el-table-column prop="otherMin" align="center" label="最小" />
                                </el-table-column>
                                <el-table-column label="操作" width="80" align="center">
                                    <template #default="scope">
                                        <el-button icon="ele-Delete" size="small" link type="danger" @click="deleteInspection(scope.$index)"> 删除
                                        </el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
						...
						<el-card shadow="always" style="height: 780px">
							...
							<el-table :data="ruleForm.productMedicationRelations" style="padding-bottom: 40px">
								...
								<el-table-column prop="targetName" label="名称" width="230" />
								<el-table-column prop="targetUnit" label="单位" show-overflow-tooltip="" />
								<el-table-column prop="targetSpecific" label="规格" show-overflow-tooltip="" />
								...
								<el-table-column label="操作" width="80" align="center">
									<template #default="scope">
										<el-button icon="ele-Delete" size="small" link type="danger" @click="deleteMedicationRelations(scope.$index)" />
									</template>
								</el-table-column>
							</el-table>
						</el-card>
			...
			<!-- <selectInspections ref="selectInspectionsRef" :title="'选择检查项目'" @reloadTable="selectInspectionsQuery" /> -->
...
// const selectInspections = defineAsyncComponent(() => import('/@/components/products/selectInspections.vue'));
//父级传递来的函数，用于回调
const emit = defineEmits(['reloadTable']);
const stores = useUserInfo();
const ruleFormRef = ref();
const productRef = ref();
// const selectInspectionsRef = ref();
...
//     ruleForm.value.productMedicationInspectionDetails.splice(index, 1);
// }
/**
 * 移除关联
 * @param index
...
// const selectInspectionsQuery = (data: any) => {
//     ruleForm.value.productMedicationInspectionDetails = data;
// }
// //清除已选的化验项目
// const selectInspectionsClear = () => {
//     ruleForm.value.productMedicationInspectionDetails = [];
// }
// //打开选择化验项目弹窗
// const openInspectionsDialog = () => {
//     selectInspectionsRef.value.openDialog(ruleForm.value);
// }
...
const openDialog = (row: any) => {
	...
	// if (!ruleForm.value.productMedicationInspectionDetails)
	//     ruleForm.value.productMedicationInspectionDetails = [];
	...
	ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
		if (isValid) {
			...
			if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
				await getAPI(ProductMicroscopeApi).apiProductMicroscopeEditPut(values);
			} else {
				await getAPI(ProductMicroscopeApi).apiProductMicroscopeAddPost(values);
			}
			closeDialog();
		}
	});
