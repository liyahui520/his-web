...
import EditOpenAccess from '/@/views/platform/openAccess/component/editOpenAccess.vue';
import HelpView from '/@/views/platform/openAccess/component/helpView.vue';
import ModifyRecord from '/@/components/table/modifyRecord.vue';
import GenerateSign from '/@/views/platform/openAccess/component/generateSign.vue';
