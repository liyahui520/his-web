				...
				<el-row :gutter="8">
					...
					<el-col :span="16">
						<!-- <el-card shadow="always" style="height: 380px;padding-bottom: 40px;">
                            <template #header>
                                <el-row justify="space-between">
                                    ...
                                    <el-col :span="6">
                                        <el-button icon="ele-Plus" size="small" type="primary"
                                            @click="openInspectionsDialog"> 新增
                                        </el-button>
                                        <el-button icon="ele-Delete" type="danger" size="small"
                                            @click="selectInspectionsClear">
                                            清空
                                        </el-button>
                                    </el-col>
                                </el-row>
                            </template>
                            <el-table :data="ruleForm.productMedicationInspectionDetails" style="width: 100%" border
                                size="small">
                                ...
                                <el-table-column label="操作" width="80" align="center">
                                    <template #default="scope">
                                        <el-button icon="ele-Delete" size="small" type="danger"
                                            @click="deleteInspection(scope.$index)"> 删除
                                        </el-button>
                                    </template>
                                </el-table-column>
                            </el-table>
						...
						<el-card shadow="always" style="height: 780px">
							...
							<el-table :data="ruleForm.productMedicationRelations" style="width: 100%; margin-bottom: 50px" >
                                <el-table-column type="index" label="序号" width="55" align="center" />
								<el-table-column prop="productTypeText" align="center" label="类型" width="100">
									<template #default="scope">
	...
	ruleFormRef.value.validate(async (isValid: boolean, fields?: any) => {
		if (isValid) {
			...
			if (ruleForm.value.id != undefined && ruleForm.value.id > 0) {
				await getAPI(ProductTestApi).apiProductTestEditPut(values);
			} else {
				await getAPI(ProductTestApi).apiProductTestAddPost(values);
			}
			closeDialog();
		}
	});
