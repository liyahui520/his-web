    ...
    <div class="productgoods-container">
        <el-card shadow="never" :body-style="{ paddingBottom: '0', border: '0px' }">
            <el-form :model="queryParams" ref="queryForm" :inline="true" label-width="70px">
                ...
                <el-form-item label="">
                    <el-checkbox border label="可订"
                        v-show="productTypesValue == '10001' || productTypesValue == '20001' || productTypesValue == '50001' || productTypesValue == '60001' || productTypesValue == '110001' || productTypesValue == '120001'"
                        v-model="queryParams.canOrder" />
                    <el-checkbox border label="可销" v-model="queryParams.canSale" />
                    <el-checkbox border label="可盘"
                        v-show="productTypesValue == '10001' || productTypesValue == '20001' || productTypesValue == '50001' || productTypesValue == '60001' || productTypesValue == '110001' || productTypesValue == '120001'"
                ...
                <el-form-item>
                    <el-button-group>
                        <el-button type="primary" icon="ele-Search" @click="handleQuery"
                            v-auth="'products:goods:query'">
                            查询
                        </el-button>
                        <el-button icon="ele-Refresh"
                            @click="() => queryParams = { canOrder: true, canSale: true, isDiscount: true }">
                            重置
                        </el-button>
                    </el-button-group>
                </el-form-item>
                <el-form-item>
                    <el-button-group>
                        <el-button type="primary" icon="ele-Plus" @click="openAddProductInfo"
                            v-auth="'products:goods:add'">
                            新增
                        </el-button>
                    </el-button-group>
                </el-form-item>
...
const loadProductTypes = async () => {
    ...
    var resultData = res ?? [];
    // productTypesData.value = [...resultData];
    resultData.forEach((element: any) => { 
        if(props.productTypes?.includes(element.itemCode))
