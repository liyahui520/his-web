...
//收费清单
export const ChargeProvider = function () {
	var addElementTypes = function (context: any) {
		context.removePrintElementTypes('ChargeModule');
		context.addPrintElementTypes('ChargeModule', [
			new hiprint.PrintElementTypeGroup('【基础数据】', [
				{ tid: 'ChargeProvider.hline', title: '横线', type: 'hline' },
				{ tid: 'ChargeProvider.vline', title: '竖线', type: 'vline' },
				{ tid: 'ChargeProvider.rect', title: '矩形', type: 'rect' },
				{
					tid: 'ChargeProvider.customText',
					title: '文本',
					customText: '自定义文本',
					custom: true,
					type: 'text',
				...
				{
					tid: 'ChargeProvider.createOrgName',
					title: '医院名称',
					data: '测试医院',
					type: 'text',
					hideTitle: true,
				...
				{
					tid: 'ChargeProvider.customerName',
					title: '动物主人/饲养单位',
					data: '卡尔',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.petGenderText',
					title: '动物性别',
					data: '公',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.serialNumber',
					title: '病例号',
					data: 'A20200101001',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.petKindText',
					title: '动物种类',
					data: '犬',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.petVarietieText',
					title: '动物品种',
					data: '柯基',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.petIdentityNumber',
					title: '犬证号码',
					data: 'P20200101001',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.petColorText',
					title: '动物毛色',
					data: '黑色',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.totalAmount',
					title: '总金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.discountAmount',
					title: '折扣金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.downIntegerAmount',
					title: '抹零金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.actlyAmount',
					title: '实付金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'ChargeProvider.doctorIdNumber',
					title: '兽医证号',
					data: 'A12345678901',
					type: 'text',
					options: {
...
//化验单模板
export const CemTestProvider = function () {
	var addElementTypes = function (context: any) {
		context.removePrintElementTypes('CemTestModule');
		context.addPrintElementTypes('CemTestModule', [
			new hiprint.PrintElementTypeGroup('【基础数据】', [
				{ tid: 'CemTestProvider.hline', title: '横线', type: 'hline' },
				{ tid: 'CemTestProvider.vline', title: '竖线', type: 'vline' },
				{ tid: 'CemTestProvider.rect', title: '矩形', type: 'rect' },
				{
					tid: 'CemTestProvider.customText',
					title: '文本',
					customText: '自定义文本',
					custom: true,
					type: 'text',
				...
				{
					tid: 'CemTestProvider.createTime',
					title: '开具日期',
					data: '2000-01-01',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.createOrgName',
					title: '医院名称',
					data: '测试医院',
					type: 'text',
					hideTitle: true,
				...
				{
					tid: 'CemTestProvider.customerName',
					title: '动物主人/饲养单位',
					data: '卡尔',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.cardNumber',
					title: '用户编号',
					data: 'C20200101001',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.petGenderText',
					title: '动物性别',
					data: '公',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.serialNumber',
					title: '病例号',
					data: 'A20200101001',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.petKindText',
					title: '动物种类',
					data: '犬',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.petVarietieText',
					title: '动物品种',
					data: '柯基',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.petIdentityNumber',
					title: '犬证号码',
					data: 'P20200101001',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.petColorText',
					title: '动物毛色',
					data: '黑色',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.totalAmount',
					title: '总金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.discountAmount',
					title: '折扣金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.downIntegerAmount',
					title: '抹零金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.actlyAmount',
					title: '实付金额',
					data: '0.00',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.doctorIdNumber',
					title: '兽医证号',
					data: 'A12345678901',
					type: 'text',
					options: {
				...
				{
					tid: 'CemTestProvider.doctorName',
					title: '执业兽医师',
					data: '楚云飞',
					type: 'text',
					options: {
