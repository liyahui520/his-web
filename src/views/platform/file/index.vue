	...
	<div class="sys-file-container">
		<el-card shadow="hover" :body-style="{ paddingBottom: '0' }">
			<el-form :model="state.queryParams" ref="queryForm" :inline="true">
				...
				<el-form-item>
					<el-button type="primary" icon="ele-Plus" @click="openUploadDialog" > 上传 </el-button>
				</el-form-item>
			</el-form>
		</el-card>
			...
			<el-table :data="state.fileData" style="width: 100%" v-loading="state.loading" border>
				...
				<el-table-column prop="url" label="预览" align="center">
					<template #default="scope">
						...
						>
							<template #error>
                                <img v-if="scope.row.suffix=='.docx'" src="../../../assets/Word.png" height="60" width="60"/>
                                <img v-if="scope.row.suffix=='.xlsx'" src="../../../assets/Excel.png" height="60" width="60"/>
                                <img v-if="scope.row.suffix=='.pdf'" src="../../../assets/Pdf.png" height="60" width="60"/>
                                <img v-if="scope.row.suffix=='.txt'" src="../../../assets/Txt.png" height="60" width="60"/>

                                <img v-else src="../../../assets/weizhi.png" height="60" width="60"/>
                            </template>
						</el-image>
					</template>
				</el-table-column>
		...
		<el-drawer :title="state.fileName" v-model="state.dialogDocxVisible" size="50%" destroy-on-close>
			<vue-office-docx :options="editorOptions" :src="state.docxUrl" style="height: 100vh" @rendered="renderedHandler" @error="errorHandler" />
		</el-drawer>
...
import EditSysFile from '/@/views/platform/file/component/editSysfile.vue';
