    ...
    <el-card class="box-card" style="width:380px;height: 150px;border-radius: 15px;" :body-style="{ padding: '0px' }">
        <el-row :gutter="10">
            <el-col :span="24">
                ...
                <span style="float: right;margin-right: -5px"><el-button icon="ele-Edit" size="small" text=""
                                                                         type="primary" title="编辑"
                                                                         @click="editPet"></el-button></span>
            </el-col>
            <el-col :span="24" style="padding-left: 10px">
                ...
                <div style="float: left;margin-left: 10px;">
                    <div>
                        <el-link target="_blank" style="font-weight: bold;font-size: 16px">{{ props?.pet?.petName }}-({{props?.pet?.petKindText}})
                        </el-link>
                    </div>
