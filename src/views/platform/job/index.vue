...
import EditJobDetail from '/@/views/platform/job/component/editJobDetail.vue';
import EditJobTrigger from '/@/views/platform/job/component/editJobTrigger.vue';
import JobCluster from '/@/views/platform/job/component/jobCluster.vue';
